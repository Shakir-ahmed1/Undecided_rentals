  ...
  return (
    <>
      {!loading ? (
        ...
        <MoreVertIcon style={{position:'absolute',top:'5px', right:'5px', color:'white', cursor:'pointer'}} fontSize="large"/>
        <CardContent>
          ...
          <Box display="flex" justifyContent="space-between">
            ...
            <Typography variant="subtitle1">{rental?.numberOfRooms}</Typography>
          </Box>
          <Box display="flex" justifyContent="space-between">
        ...
        <Box display="flex" justifyContent="space-between">
          <FavoriteBorderIcon fontSize="large" color="primary" variant="contained" style={{
            position:'relative',
            bottom:'10px',
            left:'10px',
            cursor:'pointer'
          }}/>
          <Button variant="contained" color="error" style={{position:'relative', right:'10px', bottom:'10px'}}>
            Delete
          </Button>
        </Box>
      </Card>
