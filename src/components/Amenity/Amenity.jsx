  ...
  return (
    <div>
        <form action="" onSubmit={handleAmenitySubmit}>
            <CloseIcon onClick={() => setOpenAmenity(false)} style={{cursor:'pointer'}}/>
            ...
            />
            <Button variant="contained" color="primary" size="large" type="submit" fullWidth style={{marginBottom:'10px'}} disabled={''}>Add Amenity</Button>
            <Button variant="contained" color="secondary" size="large" onClick={back} fullWidth>back</Button>
        </form>
    </div>
  )
}
